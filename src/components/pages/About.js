    ...
    render() {
        return (
            <div className="page padded">
                ...
                <br/><br/>
                I'm a Software and Web Developer. I studied Computer Information Systems at Castleton University and graduated in December 2020.
                <br/><br/>
                ...
                <br/><br/>
                I want to build a respectable portfolio and I want to work on more projects that have the potential to earn me passive income.
                <br/><br/>
                In other words, creating this website was simply the path of least resistance. I made a resource for myself that hopefully can benefit other people as well. I hope you find whatever you're looking for! If not, please don't hesitate to reach out. You can find me in the "Connect" tab.
                </p>
