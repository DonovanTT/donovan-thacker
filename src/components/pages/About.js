    ...
    render() {
        return (
            <div className="page padded">
                ...
                <br/><br/>
                I want to build a respectable portfolio to demonstrate that I am a capable front-end developer, and I want to work on more projects that have the potential to earn me passive income.
                <br/><br/>
                In other words, creating this website was simply the path of least resistance. I made a resource for myself that hopefully can benefit other people as well. I hope you find whatever you're looking for! If not, don't hesitate to reach out.
                </p>
