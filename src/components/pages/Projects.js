        ...
        <div>
            ...
            <div className="page padded">
                <div>
                    ...
                    <p className="projectText"> This project began as a 2D Breath of the Wild clone, but the farther I take it the more ideas I have for it. So far it's mostly just an inventory system, a camera system and a save file handler.</p>
